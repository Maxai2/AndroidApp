...
public class CommunityActivity extends AppCompatActivity
    ...
    private CommunityActivity.SectionsPagerAdapter mSectionsPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Сообщества");
        ...
        mSectionsPagerAdapter = new CommunityActivity.SectionsPagerAdapter(getSupportFragmentManager());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem mS = menu.findItem(R.id.action_find);
        mS.setVisible(false);

        MenuItem mR = menu.findItem(R.id.action_refresh);
        mR.setVisible(false);
...
//        }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
            ...
            public Fragment getItem(int position) {
                switch (position) {
                    case 0:
                        return PlaceholderFragment.newInstance("Все Сообщества");
                    case 1:
                        return PlaceholderFragment.newInstance("Мои Сообщества");
                }
